...
public class PasswordUtil {
	...
	*/
     ...
     * @throws Exception 
	 */
	public static String byte2hex(String value, String _key) throws Exception {
		byte b[] =  encrypt(value, _key);
		String hs = "";
		String stmp = "";
	...
	* @throws Exception 
	*/ 
	private static byte[] encrypt(String value, String _key)throws Exception { 
