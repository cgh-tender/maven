...
public class FieldPublicFilter {
	...
	private List<String> BFexport = new ArrayList<String>();
	...
	private FieldPublicFilter() {
		...
		BFexport = Arrays.asList("limit","start","prov_id","dt","fileName","city_id"); 
	}
	...
	public List<String> getBFexport() {
		return BFexport;
	}

	public void setBFexport(List<String> bFexport) {
		BFexport = bFexport;
	}
