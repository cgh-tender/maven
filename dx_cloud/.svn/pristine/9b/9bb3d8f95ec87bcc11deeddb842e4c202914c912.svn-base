...
public class RegistrationService {
	...
	public static DiscoveryInformation performDiscoveryOnUserSuppliedIdentifier(String userSuppliedIdentifier) {
		...
		System.out.println("consumerManager==="+consumerManager);
	 ...
	 *  out.
	 */
	public static RegistrationModel processReturn(DiscoveryInformation discoveryInformation, String returnToUrl, ParameterList response) {
	...
	public static void setReturnToUrl(String returnToUrl) {
	    RegistrationService.returnToUrl = returnToUrl;
	}
